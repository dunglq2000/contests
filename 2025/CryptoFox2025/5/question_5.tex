...
\begin{center}
    \Huge\textbf{Задача 5. ``Шифрование в RSA''}
\end{center}

\section{Программный код атаки Coppersmith}

Используем атаку Coppersmith с использованием SageMath:
...
\section{Результат выполнения кода}
